var r=(o,e,t)=>new Promise((d,c)=>{var l=a=>{try{s(t.next(a))}catch(i){c(i)}},u=a=>{try{s(t.throw(a))}catch(i){c(i)}},s=a=>a.done?d(a.value):Promise.resolve(a.value).then(l,u);s((t=t.apply(o,e)).next())});import{setLocalStorage as n}from"./utils.js";import{updateCartNumber as p}from"./header.js";export default class h{constructor(e,t){this.productId=e,this.product={},this.dataSource=t}init(){return r(this,null,function*(){this.details=yield this.dataSource.findProductById(this.productId),this.renderProductDetails("product-detail"),document.getElementById("addToCart").addEventListener("click",this.addToCart.bind(this))})}addToCart(e){return r(this,null,function*(){const t=JSON.parse(localStorage.getItem("so-cart"))||[],d=[...t,this.details];n("so-cart",d),p(),document.querySelector(".cart").classList.add("cart-animate"),setTimeout(function(){document.querySelector(".cart").classList.remove("cart-animate")},2e3)})}renderProductDetails(e){console.log(e);const t=`
